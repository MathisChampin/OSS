                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.nom_centre ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            />
                            {errors.nom_centre && (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.ville ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            />
                            {errors.ville && (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-20 px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.code_postal ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            />
                            {errors.code_postal && (
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.id_hop ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                                <option value=""> </option>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.rea_usc ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                                <option value=""></option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.rea_usc_2 ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                                <option value=""></option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.rea_sspi ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                                <option value=""></option>
                                <option value="Non">Non</option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.rea_sspi_2 ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                                <option value=""></option>
                        ...
                        <div>
                            ...
                            <select
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.activite ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            >
                                <option value=""></option>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.nom ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            />
                            {errors.nom && (
                        ...
                        <div>
                            ...
                            <input
                                ...
                                className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.prenom ? 'border-red-500' : 'border-gray-300'
                                    }`}
                            />
                            {errors.prenom && (
                ...
                <div className="space-y-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className={`w-full px-4 py-2 border rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 ${errors.ecmo ? 'border-red-500' : 'border-gray-300'
                                }`}
                        >
                            <option value=""></option>
                            <option value="non">Non</option>
